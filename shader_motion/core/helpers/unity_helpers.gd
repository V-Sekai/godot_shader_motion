...
static func _look_rotation_case_a(vector_a: Vector3, vector_b: Vector3, vector_c: Vector3, bx_cy_az: float) -> Quaternion:
...
#	return quaternion;
	...
	return Quaternion((vector_c.z - vector_a.y) * xyz_operand, (vector_a.x - vector_b.z) * xyz_operand, (vector_b.y - vector_c.x) * xyz_operand, unknown * 0.5)


static func _look_rotation_case_b(vector_a: Vector3, vector_b: Vector3, vector_c: Vector3) -> Quaternion:
...
#	quaternion.w = (vector_c_z - vector_a_y) * num4;
	...
	return Quaternion(0.5 * x_operand, (vector_b.y + vector_c.x) * yzw_operand, (vector_b.z + vector_a.x) * yzw_operand, (vector_c.z - vector_a.y) * yzw_operand)


static func _look_rotation_case_c(vector_a: Vector3, vector_b: Vector3, vector_c: Vector3) -> Quaternion:
...
#	quaternion.w = (vector_a_x - vector_b_z) * num3;
	...
	return Quaternion((vector_c.z + vector_b.y) * xzw_operand, 0.5 * y_operand, (vector_a.y + vector_c.z) * xzw_operand, (vector_a.x - vector_b.z) * xzw_operand)


static func _look_rotation_case_d(vector_a: Vector3, vector_b: Vector3, vector_c: Vector3) -> Quaternion:
...
#	quaternion.w = (vector_b_y - vector_c_x) * num2;
	...
	return Quaternion((vector_a.x + vector_b.z) * xyw_operand, (vector_a.y + vector_c.z) * xyw_operand, 0.5 * z_operand, (vector_b.y - vector_c.x) * xyw_operand)


static func look_rotation(forward_vector: Vector3, up_vector: Vector3) -> Quaternion:
